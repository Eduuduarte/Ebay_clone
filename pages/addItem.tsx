        ...
        <div>
            ...
            <main className='max-w-6xl mx-auto p-10 border'>
                ...
                <div className='flex flex-col justify-center items-center md:flex-row md:space-x-5 pt-5'>
                    ...
                    <form onSubmit={minNFT} className='flex flex-col flex-1 p-2 space-y-2 justify-center'>
                        ...
                        <button type='submit' className='bg-blue-600 font-bold text-white rounded-full py-4 px-10 w-56 mt-auto mx-auto md:ml-auto'>Add/Mint Item</button>
                    </form>
                </div>
            </main>
        </div>
